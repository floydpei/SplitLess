...
Balance(u, gid, replica) ==
        ...
        IN SumFunction([ eid \in groupExpenses |-> 
                            ...
                            THEN replica.recordedExpenses[eid].amount - replica.recordedExpenses[eid].shares[u] ELSE 0 ])
...
ComputeBalances(grp, recordedExpensesIn) ==
      [ u \in USERS |->
          ...
          IN SumFunction([eid \in groupExpenses |-> 
                            ...
                            THEN recordedExpensesIn[eid].amount - recordedExpensesIn[eid].shares[u] ELSE 0])
...
\* Last modified Tue Nov 04 14:13:44 CET 2025 by floyd
