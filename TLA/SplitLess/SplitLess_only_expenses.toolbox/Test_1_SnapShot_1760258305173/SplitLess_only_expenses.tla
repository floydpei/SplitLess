...
AddExpense  ==
       ...
       \E eid \in POSSIBLE_EXPENSE_IDs  : 
        ...
        /\ LET newExpense == [ id |-> eid, creator |-> actor, amount |-> SumFunction(shares), shares |-> shares, deleted |-> deleted ]
           IN recordedExpenses' = [ recordedExpenses EXCEPT ![eid] = newExpense]
           
           
DeleteExpense ==
        \E actor \in USERS : 
        \E eid \in POSSIBLE_EXPENSE_IDs : recordedExpenses[eid] \notin {NO_EXPENSE} /\ recordedExpenses[actor].creator = actor /\ recordedExpenses[eid].deleted = FALSE
...
\* Last modified Sun Oct 12 10:38:17 CEST 2025 by floyd
